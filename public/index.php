...
<body>
  <!-- header -->
  <?php
    include('../src/presentation/templates/header.php');
    // include('../domain/entities/category.php');
...
<main class="container pt-4 ">
   <div class="row g-0 bg-body-secondary position-relative mt-5 mb-3 rounded ">
      <div class="col-md-6 mb-md-0 p-md-4">
        <img src="assets/home/img-home.png" class="w-100 rounded" alt="landing page img">
      </div>
    ...
    <div class="row">
      <?php
        include('../src/presentation/templates/cards.php');
        echo cardInformation('','Nuevos Productos para arreglar','Herramientas innovadoras para proyectos modernos.','url','','assets/home/tools-construction-1.png','Comprar ahora');
        echo cardInformation('','Contamos con varios Productos','Haz click para explorar nuestros productos.','url','','assets/home/tools-construction-2.png','Comprar ahora');
    ...
    <div class="card-group mt-3 shadow-sm rounded">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">
            <img src="assets/icons/engineering.svg" alt="payment" style="width:35px;">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">
            <img src="assets/icons/delivery.svg" alt="payment" style="width:35px;">
            Asesoramiento técnico
          </h5>
          <p class="card-subtitle mb-2 text-body-secondary">Te ayudamos a seleccionar las mejores herramientas para tus proyectos</p>
        </div>
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">
            <img src="assets/icons/payment.svg" alt="payment" style="width:35px;">
            Asesoramiento técnico
          </h5>
   ...
   <div class="row row-cols-1 row-cols-md-4 g-4 mb-3">
    ...
    <div class="card h-100">
      <img src="assets/home/img-home-1.png" class="card-img-top h-50" alt="...">
      <div class="card-body">
 ...
 <hr>
  ...
  <!-- footer -->
  <?php
    include('../src/presentation/templates/footer.php');
  ?>
